...
const SEOHead = ({ title, description, keywords, path }: SEOHeadProps) => {
  ...
  const baseUrl = 'https://basedonlinestopwatch.com';
  const fullUrl = `${baseUrl}${currentPath}`;
  
  const defaultTitle = t("Based Online Stopwatch - Free Online Timer & Stopwatch Tools");
  const defaultDescription = t("Free online stopwatch, countdown timer, and time tracking tools. Perfect for classrooms, presentations, races, and productivity. No ads, no downloads required.");
  const defaultKeywords = "online stopwatch, free timer, countdown timer, online timer, web stopwatch, classroom timer, exam timer, presentation timer, race timer, productivity timer";
